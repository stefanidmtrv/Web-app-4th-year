                        ...
                        <div class="flex rounded-lg h-full bg-white p-8 flex-col">
                            <div class="flex items-center mb-3">
                                <div
                                    class="w-16 h-16 mr-3 inline-flex items-center justify-center">
                                    <img
                                        src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c1/Flag_of_Hungary.svg/2560px-Flag_of_Hungary.svg.png"
                                        alt="My Happy SVG"/>
                                </div>
                                <h2 class="text-black text-lg font-medium">Hungary</h2>
                            </div>
                            <div class="flex-grow">
                                <p class="leading-relaxed text-base text-black">62.5
                                    MtCO2e per year</p>
